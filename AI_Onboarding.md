...
|------|---------|-------------|
| Jan 22, 2026 | **Competitor Watch Feature** - Added RSS feed scanner to Content page that auto-discovers feeds from competitor websites. Scans 10 competitors, found 3 active RSS feeds (Jolt, SafetyCulture, ComplianceMate) with 30 recent articles. "Generate Our Take" button creates Checkit-branded content on same topics using positioning doc for voice. Generates title, description, key points, LinkedIn post, and full article. Content page now has tabs for Ideas and Competitor Watch. | AI |
