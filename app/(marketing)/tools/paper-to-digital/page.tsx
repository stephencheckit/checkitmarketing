...
import { Calculator, ArrowLeft, Download, Users, Clock, Shield, AlertTriangle, ChevronDown, Zap, Thermometer, ArrowRight, Settings, BarChart3 } from 'lucide-react';
...
export default function PaperToDigitalCalculator() {
  ...
  const calculations = useMemo(() => {
    ...
    const avgAnnualEnergyCostPerUnit = currency === 'USD' ? 400 : 320;
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-400">
            Calculate the value of eliminating paper-based processes and manual logging.
          </p>
        </div>

        {/* Step Tabs */}
        <div className="flex mb-6 bg-slate-900 border border-slate-800 rounded-xl p-1">
          <button
            onClick={() => setStep(1)}
        ...
        {step === 1 && (
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            <h2 className="text-lg font-semibold text-white mb-5">Configure Your Scenario</h2>
            
            <div className="grid sm:grid-cols-2 gap-6">
              {/* Vertical Selection */}
              <div>
                <label className="block text-sm text-slate-400 mb-3">Industry Vertical</label>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-slate-400">Configured for</div>
                  <div className="font-medium text-white">{selectedVertical.name} • {inputs.locations} locations</div>
                </div>
              </div>
              <button
                onClick={() => setStep(1)}
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-emerald-900/40 to-slate-900 border border-emerald-500/30 rounded-xl p-5 text-center">
                <div className="text-sm text-emerald-400 mb-1">Total Annual Benefit</div>
                <div className="text-4xl font-bold text-white">{formatCurrency(calculations.totalAnnualBenefit)}</div>
              </div>
              <div className="bg-gradient-to-br from-blue-900/40 to-slate-900 border border-blue-500/30 rounded-xl p-5 text-center">
                <div className="text-sm text-blue-400 mb-1">ROI</div>
                <div className="text-4xl font-bold text-white">{calculations.roi}%</div>
              </div>
              <div className="bg-gradient-to-br from-purple-900/40 to-slate-900 border border-purple-500/30 rounded-xl p-5 text-center">
                <div className="text-sm text-purple-400 mb-1">Payback Period</div>
                <div className="text-4xl font-bold text-white">{calculations.paybackMonths} mo</div>
              </div>
            </div>
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xl font-semibold text-white">{formatCurrency(calculations.laborValueRepurposed)}/yr</div>
                    </div>
                  </div>
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xl font-semibold text-white">{formatCurrency(calculations.auditPrepValue)}/yr</div>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xl font-semibold text-white">{formatCurrency(calculations.managerTimeValue)}/yr</div>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xl font-semibold text-white">{formatCurrency(calculations.complianceRiskReduction)}/yr</div>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 sm:col-span-2">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xl font-semibold text-white">{formatCurrency(calculations.annualEnergySavings)}/yr</div>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="grid sm:grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-sm text-slate-500 mb-1">Est. Annual Investment</div>
                  <div className="text-2xl font-semibold text-slate-300">{formatCurrency(calculations.estimatedAnnualCost)}</div>
                ...
                <div>
                  ...
                  <div className="text-2xl font-semibold text-emerald-400">{formatCurrency(calculations.totalAnnualBenefit)}</div>
                </div>
                <div>
                  <div className="text-sm text-slate-500 mb-1">Net Annual Benefit</div>
                  <div className="text-2xl font-semibold text-white">{formatCurrency(calculations.totalAnnualBenefit - calculations.estimatedAnnualCost)}</div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-4 flex-1">
                <details className="group">
                  ...
                  <ul className="mt-3 text-xs text-slate-500 space-y-1 pl-6">
                    ...
                    <li>• 75% reduction in audit prep scrambling</li>
                    <li>• Manager time valued at 2x hourly wage</li>
                    <li>• 15% baseline violation probability, 70% risk reduction</li>
