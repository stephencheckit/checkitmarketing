/**
 * Uploads the pathology template package to HubSpot Design Manager.
 * Requires the private app to have the `content` scope.
 * Run from repo root: node hubspot/pathology/upload.js
 */
const fs = require('fs');
const path = require('path');

const DEST_FOLDER = 'market-pages/pathology';

const uploads = [
  { local: 'template.html', remote: `${DEST_FOLDER}/template.html` },
  { local: 'pathology.css', remote: `${DEST_FOLDER}/pathology.css` },
