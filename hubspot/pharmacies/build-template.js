...
body = body.replace(unsplash('photo-1576602976047'), '{{ hero_image }}');
body = body.replace(unsplash('photo-1451187580459'), '{{ narrative_image }}');
body = body.replace(unsplash('photo-1614850523459'), '{{ excursion_image }}');
...
const template = `<!--
  ...
  label: Market Page - Hospital Pharmacies
-->
...
{{ require_css(get_asset_url("./pharmacies.css")) }}
