/**
 * Uploads the pharmacies template package to HubSpot Design Manager.
 * Requires the private app to have the `content` scope.
 * Run from repo root: node hubspot/pharmacies/upload.js
 */
const fs = require('fs');
const path = require('path');

const DEST_FOLDER = 'market-pages/pharmacies';

const uploads = [
  { local: 'template.html', remote: `${DEST_FOLDER}/template.html` },
  { local: 'pharmacies.css', remote: `${DEST_FOLDER}/pharmacies.css` },
  { local: 'images/hero.jpg', remote: `${DEST_FOLDER}/images/hero.jpg` },
  { local: 'images/narrative.jpg', remote: `${DEST_FOLDER}/images/narrative.jpg` },
  { local: 'images/excursion.jpg', remote: `${DEST_FOLDER}/images/excursion.jpg` },
