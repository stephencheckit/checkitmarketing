...
import { savePositioningVersion, initializePositioningTables } from '../lib/db';
...
• IT Directors - Evaluating technology solutions, concerned with integration and security`,
          placeholder: "Who are our primary buyers? (titles, responsibilities, pain points)"
        },
        {
          id: "user-personas",
          label: "User Personas",
...
• Accelerate onboarding and reduce training costs`,
          placeholder: "Top 3-5 benefits customers get from Checkit"
        },
        {
          id: "proof-points",
          label: "Proof Points",
...
• Proven ROI through reduced waste, fewer compliance failures, and improved operational efficiency`,
          placeholder: "Stats, case studies, or evidence that supports our claims"
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: "diff-1",
          label: "Differentiator 1",
          type: "text",
          value: "Predictive Operations (Not Just Reactive Compliance)",
        ...
        },
        {
          ...
          label: "Detail",
          type: "textarea",
          value: "Unlike traditional compliance tools that simply record what happened, Checkit uses Asset Intelligence to anticipate problems before they occur. We help organizations predict compliance risks, equipment failures, and operational issues - transforming data into predictability rather than just documentation.",
          placeholder: "Explain why this matters"
        },
        {
          id: "diff-2",
          label: "Differentiator 2",
          type: "text",
          value: "Unified Platform: Workflows + IoT Monitoring",
          placeholder: "What makes us unique?"
        },
        {
          id: "diff-2-detail",
          label: "Detail",
          type: "textarea",
          value: "Competitors typically offer either workflow management OR sensor monitoring. Checkit uniquely combines both in a single integrated platform - guided digital workflows for human tasks plus automated IoT sensors for continuous environmental monitoring. This eliminates the need to stitch together multiple point solutions.",
          placeholder: "Explain why this matters"
        },
        {
          id: "diff-3",
          label: "Differentiator 3",
          type: "text",
          value: "Domain Expertise + Connected Technology",
          placeholder: "What makes us unique?"
        },
        {
          id: "diff-3-detail",
          label: "Detail",
          type: "textarea",
          value: "Checkit combines proprietary data models with in-house domain expertise across food safety, healthcare, and operational compliance. We're not just a generic software vendor - we understand the specific regulatory requirements, operational challenges, and best practices in each industry we serve.",
          placeholder: "Explain why this matters"
        }
      ]
    },
      ...
      fields: [
        {
          ...
          placeholder: "e.g., Proactive Compliance"
        },
        {
          id: "pillar-1-detail",
          label: "Supporting Points",
          type: "textarea",
          value: `• From HQ, spot essential details: Is work being done on time? Is equipment operating as it should?
• Track performance by site, team, and process
• Intervene before dips in performance turn into major issues
• Transform data into predictability, not just documentation`,
          placeholder: "Key messages under this pillar"
        },
        {
          id: "pillar-2",
          label: "Pillar 2",
          type: "text",
          value: "Scalability",
          placeholder: "e.g., Operational Visibility"
        },
        {
          id: "pillar-2-detail",
          label: "Supporting Points",
          type: "textarea",
          value: `• Real-time monitoring across multiple conditions from a single cloud system
• Continuous automated recording of temperature, humidity, equipment status
• Unified collaboration across all sites and teams
• Consistent operations whether you have 10 sites or 1,000`,
          placeholder: "Key messages under this pillar"
        },
        {
          id: "pillar-3",
          ...
          type: "text",
          value: "Simplicity",
          placeholder: "e.g., Effortless Audits"
        },
        {
          id: "pillar-3-detail",
          label: "Supporting Points",
          type: "textarea",
          value: `• Staff carry out the right tasks, the right way, without fail
...
• Accelerate onboarding and seamlessly manage flexible teams`,
          placeholder: "Key messages under this pillar"
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: "pitch-10s",
          label: "10-Second Pitch",
          type: "textarea",
          value: "Checkit is a predictive operations platform that helps organizations digitize workflows, automate monitoring, and gain real-time visibility across all their sites and assets.",
          placeholder: "One sentence that explains what Checkit does"
        },
        {
          id: "pitch-30s",
          label: "30-Second Pitch",
          type: "textarea",
          value: "Checkit replaces paper-based processes and disconnected systems with one integrated platform for operational compliance. We combine guided digital workflows for your frontline teams with IoT sensors that automatically monitor temperature, equipment, and environmental conditions. The result? Total operational foresight - you can predict problems before they happen, ensure compliance without the paperwork burden, and improve margins across every site.",
          placeholder: "A brief paragraph for quick introductions"
        },
        {
          id: "pitch-2m",
          label: "2-Minute Pitch",
          type: "textarea",
          value: `Every day, organizations waste time and money on manual compliance processes - clipboards, spreadsheets, disconnected systems. Managers lack visibility into what's actually happening at their sites. Equipment fails without warning. Audits become fire drills.
...
We work with organizations in food service, healthcare, hospitality, retail, and pharma - anywhere operational compliance matters. Would you like to see a demo?`,
          placeholder: "Full elevator pitch with problem, solution, and proof"
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: "objection-1",
          label: "Common Objection 1",
          type: "text",
          value: "We already have a system for this",
          placeholder: "e.g., \"We already have a system\""
        },
        {
          id: "response-1",
          label: "Response",
          type: "textarea",
          value: "Most organizations have some system - often paper-based, spreadsheets, or point solutions. The question is: does it give you predictive visibility? Can you see across all sites in real-time? Does it automatically capture compliance evidence? Checkit uniquely combines workflow management AND automated monitoring in one platform, eliminating the need to stitch together multiple tools. Our customers typically replace 3-4 disconnected systems.",
          placeholder: "How to address this objection"
        },
        {
          id: "objection-2",
          label: "Common Objection 2",
          type: "text",
          value: "It seems expensive / We need to see ROI",
          placeholder: "e.g., \"It seems expensive\""
        },
        {
          id: "response-2",
          label: "Response",
          type: "textarea",
          value: "The cost of NOT having visibility is much higher - compliance failures, equipment breakdowns, wasted inventory, inefficient labor. Our customers typically see ROI within months through: reduced food waste from temperature excursions, fewer failed audits and associated fines, lower training costs with guided workflows, and prevented equipment failures through predictive maintenance. We can model the ROI for your specific operation.",
          placeholder: "How to address this objection"
        },
        {
          id: "objection-3",
          label: "Common Objection 3",
          type: "text",
          value: "Our frontline team won't adopt new technology",
          placeholder: "e.g., \"Our team won't adopt it\""
        },
        {
          id: "response-3",
          label: "Response",
          type: "textarea",
          value: "This is actually where Checkit excels. Our mobile app is designed for frontline workers - intuitive, guided workflows that are easier than paper. Simplicity is one of our three core pillars. We accelerate onboarding because new staff just follow the app. And because tasks are digital, managers can see completion in real-time rather than chasing down paperwork. Teams actually prefer it once they experience how much easier their day becomes.",
          placeholder: "How to address this objection"
        }
      ]
    },
...
• Scalability - works for 10 sites or 1,000`,
          placeholder: "Why customers choose us over competitors"
        },
        {
          id: "land-mines",
          label: "Competitive Land Mines",
          type: "textarea",
          value: `Ask competitors:
...
• Can you show me a single dashboard across all sites and all data types?`,
          placeholder: "Questions to plant that highlight competitor weaknesses"
        }
      ]
    }
  ]
...
async function seedPositioning() {
  console.log('Initializing positioning tables...');
  await initializePositioningTables();
  
  console.log('Saving positioning data...');
  const result = await savePositioningVersion(
    positioningData,
    'Initial version populated with Checkit company research from checkit.net'
  );
  
  console.log('Done! Version:', result.version);
}

seedPositioning().catch(console.error);
